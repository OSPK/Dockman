...
public enum Magnifier {
    ...
    public static func scale(distance: CGFloat, stride: CGFloat) -> CGFloat {
    ...
    /// off. Includes a small cushion for the hover-grow that still applies.
    public static func headroom(iconSize: CGFloat, enabled: Bool) -> CGFloat {
